...
[Introduction & Auditors Guide](auditors-guide.md)

[Smart Contract Auditors Guide](system-contracts.md)


# Development

- [Set up Citrea developer environment](dev-setup.md)
...
- [Full Node Finality Tracking](./finality-tracking.md)

# Contracts

- [Bridge Contract](bridge-contract.md)
- [Bitcoin Light Client Contract](bitcoin-light-client-contract.md)

# Other
- [Citrea EVM differences](./eth-mainnet-evm-differences.md)