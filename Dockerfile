...
COPY . .
# Build the project
RUN SKIP_GUEST_BUILD=1 cargo build --release --bin sov-demo-rollup
...
COPY --from=builder /app/target/release/sov-demo-rollup /app/examples/demo-rollup/sov-demo-rollup
