...
impl RpcImplBlock {
    ...
    fn build_rpc_impl_trait(&self) -> proc_macro2::TokenStream {
        ...
        for method in self.methods.iter() {
            ...
            let arg_values_impl = if let Some(idx) = method.idx_of_working_set_arg {
                ...
                arg_values.extend(pre_working_set_args);
                arg_values.push(quote! { &mut Self::get_working_set(self) });
                arg_values.extend(post_working_set_args);
            ...
            let arg_values_blanket = if let Some(idx) = method.idx_of_working_set_arg {
                ...
                args.extend(pre_working_set_args);
                args.extend(post_working_set_args);
                args
            } else {
                arg_values.clone().collect()
            };
