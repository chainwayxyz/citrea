    ...
    pub(crate) fn generate_rpc(
        ...
        let rpc_storage_struct = quote! {
            struct RpcStorage #impl_generics #where_clause {
                storage: ::jsonrpsee::tokio::sync::watch::Receiver<#context_type::Storage>,
        ...
        let get_rpc_methods: proc_macro2::TokenStream = quote! {
            ...
            pub fn get_rpc_methods #impl_generics (storage: ::jsonrpsee::tokio::sync::watch::Receiver<<#context_type as ::sov_modules_api::Spec>::Storage>) -> ::jsonrpsee::RpcModule<()> #where_clause {
