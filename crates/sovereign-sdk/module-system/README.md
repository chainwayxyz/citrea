...
impl<C: Context> Bank<C> {
    pub fn transfer_from(&self, from: &C::Address, to: &C::Address, coins: Coins, working_set: &mut WorkingSet<<C as Spec>::Storage>) {
        // Implementation elided...
    }
}
```
...
impl<C: sov_modules_api::Context> sov_modules_api::Module for Bank<C> {
    ...
    fn call(&self, msg: Self::CallMessage, context: &Self::Context, working_set: &mut WorkingSet<<C as Spec>::Storage>) {
        match msg {
