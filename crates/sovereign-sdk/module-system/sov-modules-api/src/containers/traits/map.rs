    ...
    W: StateReaderAndWriter,
{
    ...
    ///
    /// fn foo<C: Context>(map: StateMap<Vec<u8>, u64>, key: &[u8], ws: &mut WorkingSet<<C as Spec>::Storage>) -> Option<u64>
    /// {
    ...
    /// use sov_modules_api::{StateMapAccessor, Context, StateMap, WorkingSet};
    ///
    /// fn foo<C: Context>(map: StateMap<Vec<u8>, u64>, key: [u8; 32], ws: &mut WorkingSet<<C as Spec>::Storage>) -> Option<u64>
    /// {
    ///     map.get(&key[..], ws)
    /// }
    /// ```
