...
use crate::schema::tables::{
    ...
    L2GenesisStateRoot, L2RangeByL1Height, LastPrunedBlock, LightClientProofBySlotNumber,
    MempoolTxs, PendingBonsaiSessionByJobId, PendingL1SubmissionJobs, PendingSequencerCommitment,
