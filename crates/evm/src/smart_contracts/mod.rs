...
mod logs_contract;
mod mcopy_contract;
mod minimal_batch_wallet_contract;
...
pub use erc20_contract::{ERC20ImplementationContract, SimpleTokenProxyContract};
...
pub use minimal_batch_wallet_contract::{Execution, MinimalBatchWalletContract};
...
pub use simple_proxy_contract::SimpleProxyContract;
