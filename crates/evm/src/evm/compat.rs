...
use alloy_primitives::{Address, Bytes, ChainId, PrimitiveSignature, TxHash, TxKind, B256, U256};
...
impl From<DoNotUseSignature> for PrimitiveSignature {
    fn from(value: DoNotUseSignature) -> Self {
        Self::new(value.r, value.s, value.odd_y_parity)
    }
}
...
impl From<DoNotUseTransactionSigned> for TransactionSigned {
    fn from(value: DoNotUseTransactionSigned) -> Self {
        Self::new(value.transaction.into(), value.signature.into(), value.hash)
    }
}
