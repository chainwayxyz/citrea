...
// pub struct CitreaEvmProcessor<'a, EXT, DB: Database> {
//     evm: CitreaEvm<'a, EXT, DB>,
// }

// #[cfg(feature = "ef-tests")]
// impl<'a, EXT, DB> BlockExecutor for CitreaEvmProcessor<'a, EXT, DB>
// where
//     DB: Database<Error = Infallible> + DatabaseCommit,
//     EXT: CitreaExternalExt,
// {
...
// #[cfg(feature = "ef-tests")]
// impl<'a, EXT, DB> PrunableBlockExecutor for CitreaEvmProcessor<'a, EXT, DB>
// where
//     DB: Database<Error = Infallible> + DatabaseCommit,
//     EXT: CitreaExternalExt,
// {
