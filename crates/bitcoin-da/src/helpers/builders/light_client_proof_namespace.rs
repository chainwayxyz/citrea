...
use super::{
    ...
    get_size_reveal, sign_blob_with_private_key, update_witness, TransactionKindLightClient,
...
pub fn create_zkproof_transactions(
    ...
    match data {
        RawLightClientData::Complete(body) => create_inscription_type_0(
            ...
            network,
            &reveal_tx_prefix,
            TransactionKindLightClient::Complete,
        ),
        ...
        RawLightClientData::BatchProofMethodId(body) => create_inscription_type_0(
            body,
            &da_private_key,
            prev_utxo,
            utxos,
...
// Creates the inscription transactions Type 0 - LightClientTxs::Complete | LightClientTxs::BatchProofMethodId
#[allow(clippy::too_many_arguments)]
#[instrument(level = "trace", skip_all, err)]
pub fn create_inscription_type_0(
    ...
    network: Network,
    reveal_tx_prefix: &[u8],
    kind: TransactionKindLightClient,
) -> Result<LightClientTxs, anyhow::Error> {
    assert!(
        matches!(
            kind,
            TransactionKindLightClient::Complete | TransactionKindLightClient::BatchProofMethodId
        ),
        "Valid type 0 transaction kinds are Complete and BatchProofMethodId"
    );
        ...
        while unsigned_commit_tx.output[0].value >= min_commit_value {
            ...
            if reveal_hash.starts_with(reveal_tx_prefix) {
                ...
                return Ok(match kind {
                    TransactionKindLightClient::Complete => LightClientTxs::Complete {
                    ...
                    TransactionKindLightClient::BatchProofMethodId => {
                        LightClientTxs::BatchProofMethodId {
                            commit: unsigned_commit_tx,
                            reveal: TxWithId {
                                id: reveal_tx.compute_txid(),
                                tx: reveal_tx,
                    ...
                    _ => panic!("Already checked, impossible"),
                });
            } else {
